...
<html>
  <head>
    ...
    <title>LOGICAL SOFTWARE DEVELOPEMENT COMPANY</title>
    <style type="text/css">
      * {
        margin: 0;
        padding: 0;
      ...
      footer {
        ...
        color: #081b29;
        box-shadow: 0 0 20px rgb(255, 0, 195);
      }
    </style>
  </head>
  <body>
    <div class="banner">
      <br />
      <div class="navbar">
        <h1 class="logo">HA<span>RI</span>D<span>EVELOPED</span></h1>
        <ul>
    ...
    <footer>
      <center>DESIGNED AND DEVELOPED BY HARISHA S(212223040065)</center>
    </footer>
  </body>
</html>
```
    ...
    <style type="text/css">
      * {
      ...
      .navbar li:hover {
        ...
        background: rgb(255, 0, 212);
        color: #081b29;
        box-shadow: 0 0 20px rgb(255, 0, 208);
      }
      .container {
        background: transparent;
        padding: 10px 5%;
      ...
      footer {
        ...
        color: #081b29;
        box-shadow: 0 0 20px rgb(255, 0, 230);
      }
    </style>
  </head>
  <body>
    ...
    <style type="text/css">
      * {
      ...
      .navbar li:hover {
        ...
        color: #081b29;
        box-shadow: 0 0 20px rgb(255, 0, 242);
      }
      .image {
        position: relative;
        border: 0;
      ...
      <div class="image">
        <table cellspacing="80" >
          <tr align="center">
            ...
            <td><img src="doremon.jpeg" /></td>
            <td><img src="monto5.jpg" /></td>
            <td><img src="susuka.jpeg " /></td>
            <td><img src="koko.jpg " /></td>
          </tr>
    ...
    <style type="text/css">
      * {
      ...
      .navbar li:hover {
        ...
        cursor: pointer;
        border-radius: 30px;
        background: rgb(214, 11, 150);
        color: #081b29;
        box-shadow: 0 0 20px rgb(196, 14, 148);
      }
      .box {
        display: flex;
        column-gap: 40px;
      ...
      footer {
        ...
        cursor: pointer;
        border-radius: 30px;
        background: rgb(224, 6, 140);
        color: #081b29;
        box-shadow: 0 0 20px rgb(218, 13, 204);
      }
    </style>
  </head>
  <body>
    <div class="banner">
      ...
      <div class="box">
        ...
        <div class="box-2">
          ...
          <p>
            <span>Address</span> :5TH Floor, Tower 15, HTS
            Building No.20,HTS DEVELOP CITY Phase-I CHENNAI HR IN 600003
          </p>
          <p><span>Email</span> : hardeveloped.official@gmail.com</p>
...
## OUTPUT:
HOME.HTML
![alt text](<Screenshot 2024-04-26 214142.png>)

PRODUCT.HTML
![alt text](<Screenshot 2024-04-26 214200.png>)

PEOPLE.HTML
![alt text](<Screenshot 2024-04-26 214209.png>)

CONTACT_US.HTML
![alt text](<Screenshot 2024-04-26 214219.png>)
